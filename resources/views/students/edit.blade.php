<x-app-layout>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div class="bg-white shadow-md rounded-2xl p-8">
            <h1 class="text-2xl font-bold text-gray-800 mb-6">✏️ Edit Student</h1>
            ...
            <form action="{{ route('students.update', $student->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    @if($student->imagePath)
                        <img src="{{ asset('storage/' . $student->imagePath) }}" class="h-20 mt-2 rounded-lg">
                    @endif
                </div>
                ...
                <div class="flex justify-end gap-4">
                    ...
                    <button type="submit"
                        class="px-5 py-2 text-sm font-semibold text-white bg-yellow-500 rounded-lg hover:bg-yellow-600">
                        Update Student
                    </button>
                </div>
            </form>
