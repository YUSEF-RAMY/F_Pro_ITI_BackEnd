        ...
        <div class="bg-white shadow-md rounded-2xl overflow-hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="p-6 flex flex-col justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-800 mb-4">{{ $student->name }}</h1>
                        <p class="text-lg text-gray-600 mb-2">Email: {{ $student->email }}</p>
                        <p class="text-lg text-gray-600 mb-2">Phone: {{ $student->phone ?? 'N/A' }}</p>
                        <p class="text-gray-500 leading-relaxed mb-6">Address: {{ $student->address ?? 'N/A' }}</p>
                    </div>
