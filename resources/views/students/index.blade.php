<x-app-layout>
    ...
    {{-- @dd($student) --}}
        ...
        ? asset('storage/' . $student->imagePath) 
        : asset('images/user-1.jpeg') }}"
                    alt="{{ $student->name }}" />
                ...
                <div class="flex mt-4 md:mt-6">
                    ...
                    <form action="{{ route('students.destroy', $student->id) }}" method="POST" class="flex-1">
                                ...
                                @method('DELETE')
                                <button type="submit"
                                    class="py-2 px-4 ms-2 text-sm font-medium text-white-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-red-700">
                                    Delete
                                </button>
                            </form>
                </div>
